<table class="responsive-table highlight ">
        ...
        <tbody>
        <?php
    $detail = "SELECT * FROM orderan ORDER BY id_order DESC";
    ...
    ?>
      <tr>
        ...
        <?php if($order[5] == "selesai"){ ?>
            <td><a class="waves-effect waves-light btn disabled">Selesai</a></td>
        <?php }else if($order[5] == "batal"){ ?>
            <td><a class="waves-effect waves-light btn disabled">Selesai</a></td>
        <?php }else{ ?>
          <td><a href="include/special-konfirmasiorder.php?id_order=<?php echo $order[0]; ?>" class="waves-effect waves-light btn">Selesai</a></td>
        <?php } ?>
      </tr>
    <?php } ?>
        </tbody>
